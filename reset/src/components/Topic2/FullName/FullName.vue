      ...
      <v-container grid-list-xl>
        ...
        <v-flex xs12 sm10 md8 offset-sm2 offset-md-4 offset-xs-6 >
          <v-card style="top:5%" max-width="750" class="mx-auto" outlined>
            <v-card-text v-bind:style="styleObject">На рабочем экране появился список фамилий, имен и отчеств. Нужно перетащить ФИО под соответствующую фотографию. Запомните, под ОДНОЙ фотографией должно стоять только ОДНО ФИО.</v-card-text>
