      ...
      <v-container grid-list-xl>
        ...
        <v-flex xs12 sm10 md8 offset-sm2 offset-md-4 offset-xs-6 >
          <v-card style="top:5%" max-width="750" class="mx-auto" outlined>
            <v-card-text v-bind:style="styleObject">На рабочем экране появился список имён и отчеств. Нужно перетащить имя-отчество под соответствующую фотографию. Запомните, под ОДНОЙ фотографией должно стоять только ОДНО имя-отчество.</v-card-text>
        ...
        <v-card-text>
            <v-container>
                <v-row style="justify-content: center">
                  ...
                  <v-list-item>
                    <v-list-item-title v-bind:style="styleObject">Результат: {{result}}/2</v-list-item-title>
                  </v-list-item>
                  </v-list-item>
                    <v-btn
                        outlined
